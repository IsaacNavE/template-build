    ...
    connectedCallback() {
      this.innerHTML = `
        ...
        <div class="fixed bottom-5 right-5 flex flex-col items-center gap-3">
          <div class="relative">
            <button id="toggle-button" class="circle-btn bg-blue-500 text-white shadow-lg hover:bg-blue-600 transition pulse">
          ...
          <div id="social-buttons" class="hidden flex items-center gap-3">
            <a href="https://facebook.com" target="_blank" class="circle-btn bg-blue-700 text-white shadow-lg hover:bg-blue-800 transition">
              <i class="fab fa-facebook text-xl"></i>
            </a>
            <a href="https://instagram.com" target="_blank" class="circle-btn bg-pink-500 text-white shadow-lg hover:bg-pink-600 transition">
              <i class="fab fa-instagram text-xl"></i>
            </a>
            <a href="https://wa.me/1234567890" target="_blank" class="circle-btn bg-green-500 text-white shadow-lg hover:bg-green-600 transition">
